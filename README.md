...
For the backend we will use postgreSQL for our server side and database management system. Information from the database will be pushed to the front end when the user requests the appropriate data.
